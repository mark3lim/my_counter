...
class EditCountingSettingView extends StatefulWidget {
  static const String routeName = '/edit_counting_setting';

  final List<Category> categories;
  final CategoryList? originalCategoryList;

  const EditCountingSettingView({
    super.key,
  ...
  @override
  State<EditCountingSettingView> createState() => _EditCountingSettingViewState();
}

class _EditCountingSettingViewState extends State<EditCountingSettingView> {
  ...
  void _onSave() async {
    ...
    try {
      ...
      final updatedCategoryList = (widget.originalCategoryList ?? CategoryList(
        name: name,
